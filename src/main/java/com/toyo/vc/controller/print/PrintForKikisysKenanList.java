package com.toyo.vc.controller.print;

import com.toyo.vc.controller.Config;
import com.toyo.vc.controller.utilities.OoxmlFastUtil;
import com.toyo.vc.controller.utilities.OoxmlFastUtil;
...
//                            OoxmlFastUtil.setData(sheet,rowCount,7,kenan.getJisyo(),null);//発見時の状況　　DB保存する時の
                            OoxmlFastUtil.setData(sheet,rowCount,8,kenan.getHakkenJyokyo(),null);//機器の事象 DB保存する時の
