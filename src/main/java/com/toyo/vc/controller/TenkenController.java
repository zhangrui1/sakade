...
public class TenkenController {
    ...
    public String saveTenkenrankAllByKoujiID(@RequestParam("id")String koujiId,
                                  ...
                                  HttpSession session,ModelMap modelMap,HttpServletRequest request) throws IOException {
        //session　check
        ...
        for (int i = 0; i < tenkenRirekiUtilList.size(); i++) {
            if(tenkenrank.length() < 1) {
                ...
                tenkenRirekiUtilList.get(i).setUpdDate(tenkenRireki.getUpdDate()+"");
        ...
        //historyテーブルを更新
        historyValveService.addHistoryValve("",koujiId+"",Config.TKoujiTenkenRankALL,session,request);
    ...
    public String saveTenkenrank(@RequestParam("id")String rirekiId,
        ...
        //historyテーブルを更新
        historyValveService.addHistoryValve("",rirekiId+"",Config.TKoujiTenkenRank,session,request);
    ...
    public String saveTenkenBikou(@RequestParam("id")String rirekiId,
        ...
        //historyテーブルを更新
        historyValveService.addHistoryValve("",rirekiId+"",Config.TKoujiTenkenBikou,session,request);
        return result;
    }
    ...
    public String saveTenkenkekka(@RequestParam("id")String rirekiId,
        ...
        //historyテーブルを更新
        historyValveService.addHistoryValve("",rirekiId+"",Config.TKoujiTenkenResult,session,request);
        return result;
    }
    ...
    @ResponseBody
    public String getKekkaListNumber(HttpSession session,ModelMap modelMap){
        //session　check
        User user=(User)session.getAttribute("user");
        if(user == null){
            modelMap.addAttribute("message",Config.TUserNull);
    ...
    @ResponseBody
    public String deleteTenkenRirekiByTenkenrireki(@RequestParam("id")String id,HttpSession session,ModelMap modelMap,HttpServletRequest request) throws IOException {
        ...
        //historyテーブルを更新
        historyValveService.addHistoryValve(Config.TTenkenRireki,id+"",Config.TDelete,session,request);
        return  "true";
    }
    ...
    @ResponseBody
    public String deleteTenkenRirekiByTenkenrirekiSearch(@RequestParam("id")String id,HttpSession session,ModelMap modelMap) throws IOException {
    ...
    @RequestMapping(value = "/saveTenkennaiyo", method = RequestMethod.POST, produces = "text/html;charset=UTF-8")
        ...
        //historyテーブルを更新
        historyValveService.addHistoryValve("",rirekiId+"",Config.TKoujiTenkenNaiyo,session,request);
        return "";
    ...
    public String getTenkenRirekiByKikisysId(@PathVariable String kikiSysId,@PathVariable String kikiOrBenFlg, ModelMap modelMap,HttpSession session,HttpServletRequest request) throws IOException {
        //session　check
        User user=(User)session.getAttribute("user");
        if(user == null){
            modelMap.addAttribute("message",Config.TUserNull);
        ...
        //historyテーブルを更新
        historyValveService.addHistoryValve("",valve.getKikiSysId()+"",Config.TTenkenList,session,request);
