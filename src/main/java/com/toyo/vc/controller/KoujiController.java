...
public class KoujiController {
    ...
    public String addKoujiByForm(@ModelAttribute("KoujiForm")KoujiForm koujiForm, ModelMap modelMap,HttpSession session,HttpServletRequest request) throws IOException {
        //session　check
...
//        List<Valve> valveList = itemService.getItemByLocationName(kouji.getLocation());
        ...
        //historyテーブルを更新
        historyValveService.addHistoryValve(Config.TKouji,kouji.getId()+"",Config.TInsert,session,request);
...
//        }
    ...
    public String DeleteKoujiById(@PathVariable("id")String id,ModelMap modelMap,HttpSession session,HttpServletRequest request) throws IOException {
        //session　check
        User user=(User)session.getAttribute("user");
        if(user == null){
            modelMap.addAttribute("message",Config.TUserNull);
        ...
        //historyテーブルを更新
        historyValveService.addHistoryValve(Config.TKouji,kouji.getId()+"",Config.TDelete,session,request);
        return "redirect:/";
    }
    ...
    public String getInstruct(@PathVariable("id")String id, ModelMap modelMap, HttpSession session,HttpServletRequest request){
        //session　check
        User user=(User)session.getAttribute("user");
        if(user == null){
            modelMap.addAttribute("message",Config.TUserNull);
        ...
        //historyテーブルを更新
        historyValveService.addHistoryValve(Config.TKouji,kouji.getId()+"",Config.TKoujiInstructDetail,session,request);
    ...
    public String getPrinthtml(@PathVariable("id")String id, ModelMap modelMap, HttpSession session,HttpServletRequest request){
        //session　check
        User user=(User)session.getAttribute("user");
        if(user == null){
            modelMap.addAttribute("message",Config.TUserNull);
        ...
        //historyテーブルを更新
        historyValveService.addHistoryValve(Config.TKouji,kouji.getId()+"",Config.TKoujiPrintDetail,session,request);
    ...
    public String getGpPrinthtml(@PathVariable("id")String id, ModelMap modelMap, HttpSession session,HttpServletRequest request){
        //session　check
        User user=(User)session.getAttribute("user");
        if(user == null){
            modelMap.addAttribute("message",Config.TUserNull);
        ...
        //historyテーブルを更新
        historyValveService.addHistoryValve(Config.TKouji,kouji.getId()+"",Config.TKoujiPrintGPDetail,session,request);
    ...
    public String getHistoryById(@PathVariable("id")String id, ModelMap modelMap, HttpSession session,HttpServletRequest request){
        //session　check
        User user=(User)session.getAttribute("user");
        if(user == null){
            modelMap.addAttribute("message",Config.TUserNull);
        ...
        //historyテーブルを更新
        historyValveService.addHistoryValve(Config.TKouji,kouji.getId()+"",Config.TKoujiHistoryDetail,session,request);
    ...
    public String getKenanByKoujiId(@PathVariable("id")String id, ModelMap modelMap, HttpSession session,HttpServletRequest request) throws IOException {
//        //点検履歴保存
//        List<TenkenRirekiUtil> tenkenRirekiUtilList = (List<TenkenRirekiUtil>) session.getAttribute("tenkenRirekiUtilList");
//        //make cache
//        session.setAttribute("tenkenRirekiUtilList",tenkenRirekiUtilList);
//        modelMap.addAttribute("tenkenRirekiUtilList", tenkenRirekiUtilList);
        ...
        //historyテーブルを更新
        historyValveService.addHistoryValve(Config.TKouji,kouji.getId()+"",Config.TKoujiKenanDetail,session,request);
    ...
    public String getKenanPast(@PathVariable("id")String id, ModelMap modelMap, HttpSession session,HttpServletRequest request) throws IOException {
        //session　check
        User user=(User)session.getAttribute("user");
        if(user == null){
            modelMap.addAttribute("message",Config.TUserNull);
        ...
        //historyテーブルを更新
        historyValveService.addHistoryValve(Config.TKouji,kouji.getId()+"",Config.TKoujiKenanPastDetail,session,request);
    ...
    @ResponseBody
    public String kenanLastYear(@RequestParam("koujiId")String koujiId,@RequestParam("kikiSysId")String kikiSysId, ModelMap modelMap, HttpSession session,HttpServletRequest request) throws IOException {
...
//        modelMap.addAttribute("kenanFormList",kenanFormList);
    ...
    @ResponseBody
    public String kenanNowYear(@RequestParam("koujiId")String koujiId,@RequestParam("kikiSysId")String kikiSysId, ModelMap modelMap, HttpSession session,HttpServletRequest request) throws IOException {
        //session　check
        User user=(User)session.getAttribute("user");
        if(user == null){
            modelMap.addAttribute("message",Config.TUserNull);
...
//        }
        ...
        //historyテーブルを更新
        historyValveService.addHistoryValve(Config.TKouji,kouji.getId()+"",Config.TKoujiImageDetail,session,request);
    ...
    public String showValveList(@PathVariable("id")String id,
                               ModelMap modelMap,HttpSession session,HttpServletRequest request) throws IOException {
        //session　check
        User user=(User)session.getAttribute("user");
        if(user == null){
            modelMap.addAttribute("message",Config.TUserNull);
...
//        }
        ...
        //historyテーブルを更新
        historyValveService.addHistoryValve(Config.TKouji,kouji.getId()+"",Config.TKoujiAddValvePage,session,request);
...
//        valveList=itemService.getKikisysByKoujiId(id);
        ...
        modelMap.addAttribute("valveList",valveList);
        //historyテーブルを更新
        historyValveService.addHistoryValve(Config.TKouji,kouji.getId()+"",Config.TKoujiAddValve,session,request);

//        return "redirect:/kouji/"+kouji.getId()+"/kiki";
        return "redirect:/kouji/"+kouji.getId()+"/instruct";
    }
...
//            }
        ...
        modelMap.addAttribute("valveList",valveList);
        //historyテーブルを更新
        historyValveService.addHistoryValve(Config.TKouji,kouji.getId()+"",Config.TKoujiAddKikiPage,session,request);
...
//            }
        ...
        //historyテーブルを更新
        historyValveService.addHistoryValve(Config.TKouji,kouji.getId()+"",Config.TKoujiAddKiki,session,request);
...
//        }
        ...
        //historyテーブルを更新
        historyValveService.addHistoryValve(Config.TNameKoujirelation,kouji.getId()+"",Config.TKoujiAddKikisysRelation,session,request);
...
//        return "kouji/addResult";
    ...
    public String saveResult(@PathVariable("id")String koujiId,
        ...
        //historyテーブルを更新
        historyValveService.addHistoryValve("",koujiId+"",Config.TKoujiAddKikisysRelation,session,request);
    ...
    @ResponseBody
    public String updateKoujiJson(@ModelAttribute("koujiForm")String koujiForm,ModelMap modelMap,HttpSession session,HttpServletRequest request) throws IOException {
        //session　check
        User user=(User)session.getAttribute("user");
        if(user == null){
            modelMap.addAttribute("message",Config.TUserNull);
        ...
        session.setAttribute("locationKoujiSelectedForKouji",tmpKoujiresult);
        //historyテーブルを更新
        historyValveService.addHistoryValve(Config.TKouji,kouji.getId()+"",Config.TEdit,session,request);
        return "";
    }
