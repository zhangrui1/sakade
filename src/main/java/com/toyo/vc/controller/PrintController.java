...
import com.toyo.vc.controller.print.*;
import com.toyo.vc.controller.utilities.OoxmlUtil;
import com.toyo.vc.controller.utilities.PrintUtil;
...
public class PrintController {
    ...
    public String printTenken(@PathVariable("id")String id, @RequestParam("idListForPrintTenken")String idListForPrintTenken,ModelMap modelMap, HttpSession session,HttpServletResponse res,HttpServletRequest request) throws IOException {
        ...
        //historyテーブルを更新
        historyValveService.addHistoryValve("",kouji.getId()+"",Config.TDLForKoujiPrintTenken,session,request);
    ...
    public String printReport(@PathVariable("id")String id,@RequestParam("idListForPrintReport")String idListForPrintReport, ModelMap modelMap, HttpSession session,HttpServletResponse res,HttpServletRequest request) throws IOException {
        //session　check
        User user=(User)session.getAttribute("user");
        if(user == null){
            modelMap.addAttribute("message",Config.TUserNull);
        ...
        //historyテーブルを更新
        historyValveService.addHistoryValve("",kouji.getId()+"",Config.TDLForKoujiPrintReport,session,request);
    ...
    public String printKenan(@PathVariable("id")String id, @RequestParam("idListForPrintKenan")String idListForPrintKenan,ModelMap modelMap, HttpSession session,HttpServletResponse res,HttpServletRequest request) throws IOException {
        ...
        if(valveKenanDLList.size()>0) {
            ...
            //historyテーブルを更新
            historyValveService.addHistoryValve("",kouji.getId()+"",Config.TDLForKoujiPrintKenan,session,request);
    ...
    public String printKenanReport(@PathVariable("id")String id,@RequestParam("kenanFlgDL")String kenanFlgDL,@RequestParam("idListForPrintKenanReport")String idListForPrintKenanReport, ModelMap modelMap, HttpSession session,HttpServletResponse res,HttpServletRequest request) throws IOException {
        //session　check
        User user=(User)session.getAttribute("user");
        if(user == null){
            modelMap.addAttribute("message",Config.TUserNull);
...
//                    }
        ...
        //historyテーブルを更新
        historyValveService.addHistoryValve("",kouji.getId()+"",Config.TDLForKoujiPrintKenanReport,session,request);
    ...
    public String printSagyo(@PathVariable("id")String id, ModelMap modelMap, @RequestParam("idListForPrintSagyo")String idListForPrintSagyo, HttpSession session,HttpServletResponse res,HttpServletRequest request) throws IOException {
        ...
        //historyテーブルを更新
        historyValveService.addHistoryValve("",kouji.getId()+"",Config.TDLForKoujiPrintSagyo,session,request);
    ...
    public String printIcs(@PathVariable("id")String id, @RequestParam("idListForPrintIcs")String idListForPrintIcs,ModelMap modelMap, HttpSession session,HttpServletResponse res,HttpServletRequest request) throws IOException {
        ...
        //historyテーブルを更新
        historyValveService.addHistoryValve("",kouji.getId()+"",Config.TDLForKoujiPrintIcs,session,request);
       /* Excel出力 */
    ...
    public String printTool(@PathVariable("id")String id, @RequestParam("idListForPrintTool")String idListForPrintTool, ModelMap modelMap, HttpSession session,HttpServletResponse res,HttpServletRequest request) throws IOException {
        ...
        //historyテーブルを更新
        historyValveService.addHistoryValve("",kouji.getId()+"",Config.TDLForKoujiPrintTool,session,request);
    ...
    public String printValve(@PathVariable("id")String id,@RequestParam("naikeiFlg")String naikeiFlg,@RequestParam("idListForValveRabel")String idListForValveRabel, ModelMap modelMap, HttpSession session,HttpServletResponse res,HttpServletRequest request) throws IOException {
        ...
        //historyテーブルを更新
        historyValveService.addHistoryValve("",kouji.getId()+"",Config.TDLForKoujiPrintValve,session,request);
    ...
    public ModelAndView printGP(@PathVariable("id")String id,@RequestParam("idList")String idList, ModelMap modelMap, HttpSession session,HttpServletResponse res,HttpServletRequest request) throws IOException, DocumentException {
...
//        List<Image> printTargeImages=new ArrayList<Image>();
        ...
        //historyテーブルを更新
        historyValveService.addHistoryValve("",kouji.getId()+"",Config.TDLForKoujiPrintGP,session,request);
        //画像をPDFに出力
     ...
     * */
    @RequestMapping(value = "/printICS/{id}", method = RequestMethod.POST)
    public ModelAndView printICS(@PathVariable("id")String id,@RequestParam("idList")String idList, ModelMap modelMap, HttpSession session,HttpServletResponse res,HttpServletRequest request) throws IOException, DocumentException {
        ...
        //historyテーブルを更新
        historyValveService.addHistoryValve("",kouji.getId()+"",Config.TDLForKoujiPrintGPIcs,session,request);
    ...
    @ResponseBody
    public String checkPrintICS(@RequestParam("idList")String idList, ModelMap modelMap, HttpSession session,HttpServletResponse res,HttpServletRequest request) throws IOException, DocumentException {
        //session　check
        User user=(User)session.getAttribute("user");
        if(user == null){
            modelMap.addAttribute("message",Config.TUserNull);
    ...
    public String printTokuBetuKakoKirokuForKikisysList(@RequestParam("idListTokuBetuKako")String idListTokuBetuKako,@RequestParam("koujiId")String koujiId, ModelMap modelMap, HttpSession session,HttpServletResponse res,HttpServletRequest request) throws IOException, DocumentException {
        //session　check
        User user=(User)session.getAttribute("user");
        if(user == null){
            modelMap.addAttribute("message",Config.TUserNull);
        ...
        //historyテーブルを更新
        historyValveService.addHistoryValve("",idList+"",Config.TDLForKikisysValveTokuBetuKako,session,request);
        /* Excel出力 */
    ...
    public String printSijisyoForKikisysList(@RequestParam("idListSijisyo")String idListSijisyo,@RequestParam("koujiIdSijisyo")String koujiIdSijisyo, ModelMap modelMap, HttpSession session,HttpServletResponse res,HttpServletRequest request) throws IOException, DocumentException {
        //session　check
        User user=(User)session.getAttribute("user");
        if(user == null){
            modelMap.addAttribute("message",Config.TUserNull);
        ...
        //historyテーブルを更新
        historyValveService.addHistoryValve("",idList+"",Config.TDLForKikisysValveSijisyo,session,request);
        /* Excel出力 */
    ...
    public String printKanriDaiTyoForKikisysList(@RequestParam("idListKanriDaiTyo")String idListKanriDaiTyo,@RequestParam("koujiIdKanriDaiTyo")String koujiIdKanriDaiTyo, ModelMap modelMap, HttpSession session,HttpServletResponse res,HttpServletRequest request) throws IOException, DocumentException {
        //session　check
        User user=(User)session.getAttribute("user");
        if(user == null){
            modelMap.addAttribute("message",Config.TUserNull);
        ...
        //historyテーブルを更新
        historyValveService.addHistoryValve("",kouji.getId()+"",Config.TDLForKoujiPrintKanriDaiTyoForKikisysList,session,request);
    ...
    public String printKikisys(@RequestParam("idList")String idList, ModelMap modelMap, HttpSession session,HttpServletResponse res,HttpServletRequest request) throws IOException, DocumentException {
        //session　check
        User user=(User)session.getAttribute("user");
        if(user == null){
            modelMap.addAttribute("message",Config.TUserNull);
        ...
        //historyテーブルを更新
        historyValveService.addHistoryValve("",idList+"",Config.TDLForKikisysDetailList,session,request);
    ...
    public String printDaityoForKikisysList(@RequestParam("idList")String idList, @RequestParam("companyLocation")String companyLocation,ModelMap modelMap, HttpSession session,HttpServletResponse res,HttpServletRequest request) throws IOException, DocumentException {
...
//                            }
        ...
        //historyテーブルを更新
        historyValveService.addHistoryValve("",idList+"",Config.TDLForKikisysValveDaityo,session,request);
        /* Excel出力 */
    ...
    public String printGPForKikisysList(@RequestParam("idList")String idList, ModelMap modelMap, HttpSession session,HttpServletResponse res,HttpServletRequest request) throws IOException, DocumentException {
        ...
        //historyテーブルを更新
        historyValveService.addHistoryValve("",idList+"",Config.TDLForKikisysValveDetailForGP,session,request);
        /* Excel出力 */
    ...
    public String printKenanForKikisys(@RequestParam("idList")String idList, @RequestParam("kenanFlgDL")String kenanFlgDL,ModelMap modelMap, HttpSession session,HttpServletResponse res,HttpServletRequest request) throws IOException, DocumentException {
        //session　check
        User user=(User)session.getAttribute("user");
        if(user == null){
            modelMap.addAttribute("message",Config.TUserNull);
...
//        System.out.println("kenanDBEndTime   =  "+(kenanDBEndTime-kenanStartTime));
        ...
        //historyテーブルを更新
        historyValveService.addHistoryValve("",idList+"",Config.TDLForKikisysValveKenan,session,request);
