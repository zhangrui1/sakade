...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="btn-group" role="group">
            <a href="/sakade/item/${valve.kikiSysId}/${kikiOrBenFlg}/valve" class="btn btn-default bg-yellow active">弁基本情報</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="operation-button">
                                        <a class="btn btn-info btn-sm operation-button-btn" href="/sakade/item/${valve.kikiSysId}/${tmpkiki.kikiId}/${kikiOrBenFlg}/valve"><i class="fa fa-arrow-right"></i></a>
                                    </div>
                                </td>
                            </tr>
