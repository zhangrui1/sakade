<%@ page import="com.toyo.vc.dto.KenanForm" %>
...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="btn-group" role="group">
            ...
            <a href="/sakade/kenan/kenan/${valve.kikiSysId}/${kikiOrBenFlg}/valve" class="btn btn-default bg-yellow active">懸案</a>
            <a href="/sakade/tenken/tenken/${valve.kikiSysId}/${kikiOrBenFlg}/valve" class="btn btn-default">点検履歴</a>
            <a href="/sakade/image/image/${valve.kikiSysId}/${kikiOrBenFlg}/valve" class="btn btn-default">図面</a>
...
<script type="text/javascript">
    function editKenan(obj){
        ...
        $.get("/sakade/kenan/getKenanByIdInSessionSearch",{"id":kenanId},function(data){
            if(data=="login"){
                logoutFun();
            }
