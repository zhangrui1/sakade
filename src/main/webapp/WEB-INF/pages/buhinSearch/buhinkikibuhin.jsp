...
<section class="content-header">
    <h1>
        <ol class="breadcrumb">
            <li class="active"><a href="/sakade/item/${valve.kikiSysId}/${kikiOrBenFlg}/valve"><i class="fa fa-dashboard"></i>弁情報</a></li>
            <li>機器情報</li>
        </ol>
    </h1>
</section>
...
<script type="text/javascript">
    ...
    function buhinDetail(obj){
        ...
        $.get("/sakade/item/getBuhin",{"buhinId":buhinId},function(data){
            if(data=="login"){
                logoutFun();
            }
