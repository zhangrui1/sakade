                                        ...
                                        <tbody id="koujiList">
                                            <c:forEach items="${locationKoujiSelectedForKouji}" var="tempkouji">
                                                <tr id="${tempkouji.id}">
                                                    ...
                                                    <td><a class="btn btn-primary btn-sm operation-button-btn" href="/sakade/kouji/${tempkouji.id}"><i class="glyphicon glyphicon-pencil">詳細</i></a></td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#currentLocation").change(function(){
            ...
            //sessionに保存
            $("#table_search").val("");
            $.get("/sakade/item/koujiFilter",{"filterKeyword":""},function(data){
                if(data=="login"){
                    logoutFun();
                }
                return true;
...
//            検索キーワードを取得、小文字に変更し、両端の空白を削除
        ...
        //sessionに保存
        $.get("/sakade/item/koujiFilter",{"filterKeyword":keyword},function(data){
            if(data=="login"){
                logoutFun();
            }
            return true;
