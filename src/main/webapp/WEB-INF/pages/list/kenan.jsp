        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="btn-group" role="group">
                    ...
                    <a href="/sakade/list/kenan" class="btn btn-default bg-yellow active">懸案</a>
                    <a href="/sakade/list/tenken" class="btn btn-default">点検履歴</a>
                </div>
            </div>
            <form class="navbar-form navbar-left" role="search" id="searchForm" action="/sakade/kenan/search/">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="kenanForm" action="/sakade/kenan/updateKenanSearch" name="kenanForm" method="post">
...
<script type="text/javascript">
    ...
    function deleteKenan(obj) {
        ...
        $.get("/sakade/kenan/deleteSearch",{"id":kenanId},function(data){
            if(data=="login"){
                logoutFun();
            }
