        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="btn-group" role="group">
                    <a href="/sakade/list" class="btn btn-default">工事</a>
                    <a href="/sakade/list/kenan" class="btn btn-default">懸案</a>
                    <a href="/sakade/list/tenken" class="btn btn-default bg-yellow active">点検履歴</a>
                </div>
            </div>
            <form class="navbar-form navbar-left" role="search" id="searchForm" action="/sakade/tenken/search/">
...
<script type="text/javascript">
    ...
    function deleteTenkenKiki(obj){
        ...
        $.get("/sakade/tenken/deleteTenkenRirekiByTenkenrirekiSearch",{"id":rirekiId},function(data){
            if(data=="login"){
                logoutFun();
            }
    ...
    function saveTenkenrank(obj){
        ...
        $.post("/sakade/tenken/saveTenkenrankSearch",{"id":rirekiId,"tenkenrank":obj.value,"tenkennaiyo":tenkennaiyo},function(data){
            if(data=="login"){
                logoutFun();
            }
            if(data == '完成'){
    ...
    function saveTenkennaiyo(obj){
        var rireki = $(obj).parent().parent();
        var rirekiId = rireki[0].id;
        $.post("/sakade/tenken/saveTenkennaiyoSearch",{"id":rirekiId,"tenkennaiyo":obj.value},function(data){
            if(data=="login"){
                logoutFun();
            }
            if(data == '0'){
