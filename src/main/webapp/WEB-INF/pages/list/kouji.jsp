        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <div class="btn-group" role="group">
                    <a href="/sakade/list" class="btn btn-default bg-yellow active">工事検索</a>
                    <%--<a href="/sakade/list/kenan" class="btn btn-default">懸案</a>--%>
                    <%--<a href="/sakade/list/tenken" class="btn btn-default">点検履歴</a>--%>
                    <a href="/sakade/list/valve" class="btn btn-default">弁検索</a>
                </div>
            </div>
            <div class="col-md-3">
                <form class="btn-group" role="search" id="searchForm" action="/sakade/kouji/search/" method="post">
                            ...
                            <tr id="${kouji.id}">
                                ...
                                <td>
                                    <%--<div class="operation-button">--%>
                                        <a class="btn btn-primary btn-sm operation-button-btn" href="/sakade/kouji/${kouji.id}"><i class="glyphicon glyphicon-pencil">詳細</i></a>
                                    <%--</div>--%>
                                </td>
                            </tr>
                        </c:forEach>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#currentLocation").change(function(){
            ...
            $.post("/sakade/kouji/getKoujiByLocation",{"location":location},function(data){
                if(data=="login"){
                    logoutFun();
                }
    ...
    function makeUpTable(items){
        ...
        for(var i = 0;i<items.length;i++){
            htmlContent =
                    ...
                    '<td>' +
                    '<a class="btn btn-primary btn-sm operation-button-btn" href="/sakade/kouji/'+items[i].id+'"><i class="glyphicon glyphicon-pencil">編集</i></a>' +
                    '</td>' +
                    '</tr>';
        }
