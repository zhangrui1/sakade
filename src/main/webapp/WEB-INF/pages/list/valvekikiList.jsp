            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="btn-group" role="group">
                        <a href="/sakade/list/valveMult" class="btn btn-default" onclick="return saveSelectedForKiki()">複合検索</a>
                        <a href="/sakade/list/valve" class="btn btn-default" onclick="return saveSelectedForKiki()">弁検索</a>
                        <a href="/sakade/list/kikiSearch" class="btn btn-default bg-yellow active" onclick="return saveSelectedForKiki()">機器検索</a>
                        <a href="/sakade/list/buhinSearch" class="btn btn-default" onclick="return saveSelectedForKiki()">部品検索</a>
                    </div>
                </div>
            </div></br></br>
            <div class="row">
                    ...
                    <%--<div class="panel-body">--%>
                        ...
                        <%--<div class="row">--%>
                            <%--<div class="col-md-4 col-xs-4">--%>
                                <%--<form action="/sakade/item/kikiSearch" method="post" class="sidebar-form"  name="kikisearchForm">--%>
                                    <%--<div class="input-group">--%>
            ...
            <div class="row">
                <div class="panel panel-success">
                    ...
                    <div class="panel-body" id="searchForKiki" >
                        <div class="row">
                            <div class="col-md-14">
                                <form action="/sakade/item/kikiSearchForSeikak" method="post" class="sidebar-form"  name="kikisearchFormForSeikak" onsubmit="return checkValveSearchForSeikak();">
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="col-md-1">
                                        ...
                                        <div class="box-body clearfix">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <span id="valve_num" class="valve_num pull-right" STYLE="font-size: 16px;">ヒット弁 ${kikiSearchitemNum} 台 (${searchValveKikiTotalTime}秒)</span>
                                                </div>
                                                <div class="col-md-2">
                                ...
                                <table class="table table-hover select-table result-table table-bordered">
                                    ...
                                    <c:forEach items="${kikiSearchitemResults}" var="item">
                                        <tr class="valve-item" id="${item.valve.kikiSysId}">
                                            ...
                                            <td>
                                                <a class="btn btn-primary btn-sm operation-button-btn" href="/sakade/item/${item.valve.kikiSysId}/${kikiOrBenFlg}/valve" onclick="return saveSelectedForKiki()">詳細</a>
                                            </td>
...
//        });
    ...
    function filterPage(){
        ...
        //sessionに保存
        $.get("/sakade/item/valveKikiFilter",{"filterKeyword":keyword},function(data){
            if(data=="login"){
                logoutFun();
            }
            return true;
...
//        var isKenan=false;
    ...
    function check(code){
        if(code==13){
            ...
            $("#loading").fadeIn();
            //sessionに保存
            $.get("/sakade/item/valveKikiFilter",{"filterKeyword":""},function(data){
                if(data=="login"){
                    logoutFun();
                }
                return true;
...
//        }
    ...
    function saveSelectedForKiki(){
        ...
        //Filter sessionに保存
        $.get("/sakade/item/saveSelectedForValve",{"idList":idList,"type":"2"},function(data){
            if(data=="login"){
                logoutFun();
            }
            return true;
