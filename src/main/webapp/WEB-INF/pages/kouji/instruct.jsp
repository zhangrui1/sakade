                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-md-1 kengen-person">
                                    <form action="/sakade/kouji/delete/${kouji.id}" method="post" onsubmit="return deleteKouji()">
                        ...
                        <div class="panel panel-default progress-panel" id="tenkenRireki-content">
                            ...
                            <div class="row tool-row">
                                <div class="col-md-2 kengen-person"><a href="/sakade/kouji/${kouji.id}/valve" class="btn btn-success bg-middle-green btn-sm" ><i class="fa fa-plus">点検弁追加</i></a></div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        <%--//工事区分 Master を呼ぶ--%>
        <%--$.post("/sakade/master/getMasterByTypeJson",{"type":'工事区分'},function(data){--%>
        ...
        <%--//責任者 Master を呼ぶ--%>
        <%--$.post("/sakade/master/getMasterByTypeJson",{"type":'責任者'},function(data){--%>
            <%--var masters = JSON.parse(data);--%>
            <%--$('#person').html("");--%>
        ...
        <%--//主管係 Master を呼ぶ--%>
        <%--$.post("/sakade/master/getMasterByTypeJson",{"type":'主管係'},function(data){--%>
            <%--var masters = JSON.parse(data);--%>
            <%--$('#syukan').html("");--%>
        ...
        <%--//主管係 Master を呼ぶ--%>
        <%--$.post("/sakade/master/getMasterByTypeJson",{"type":'点検業者'},function(data){--%>
            <%--var masters = JSON.parse(data);--%>
            <%--$('#gyosyaRyakuA').html("");--%>
    ...
    function saveAllTenkenRank(obj){
        ...
        $.post("/sakade/tenken/saveTenkenrankAllByKoujiID",{"id":koujiId,"tenkenrank":obj.value,"tenkennaiyo":tenkennaiyo},function(data){
           console.log("DB更新した");
            if(data=="login"){
                logoutFun();
            }
    ...
    function saveTenkenrank(obj){
        ...
        $.post("/sakade/tenken/saveTenkenrank",{"id":rirekiId,"tenkenrank":obj.value,"tenkennaiyo":tenkennaiyo},function(data){
            if(data=="login"){
                logoutFun();
            }
            if(data == '完成'){
    ...
    function saveTenkenkekka(obj){
        var rireki = $(obj).parent().parent();
        var rirekiId = rireki[0].id;
        $.post("/sakade/tenken/saveTenkenkekka",{"id":rirekiId,"tenkenkekka":obj.value},function(data){
            if(data=="login"){
                logoutFun();
            }
            if(data == '0'){
    ...
    function saveTenkenBikou(obj){
        ...
        if(obj.value.length>255){
            ...
            $.post("/sakade/tenken/saveTenkenBikou",{"id":rirekiId,"tenkenBikou":obj.value},function(data){
                if(data=="login"){
                    logoutFun();
                }
                if(data == '0'){
    ...
    function saveTenkennaiyo(obj){
        ...
        if(obj.value.length>199){
            ...
            $.post("/sakade/tenken/saveTenkennaiyo",{"id":rirekiId,"tenkennaiyo":obj.value},function(data){
                if(data=="login"){
                    logoutFun();
                }
                if(data == '0'){
    ...
    function updateListNumbers(){
        $.get("/sakade/tenken/getListNumber",function(data){
    ...
    function updateKekkaListNumbers(){
        $.get("/sakade/tenken/getKekkaListNumber",function(data){
            if(data=="login"){
                logoutFun();
            }
            var datas = JSON.parse(data);
    ...
    function openKenan(obj){
        ...
        $.get("/sakade/kenan/addKenanByTenkenrireki",{"id":rirekiId},function(data){
            if(data=="login"){
                logoutFun();
            }
    ...
    function deleteTenkenKiki(obj){
        ...
        $.get("/sakade/tenken/deleteTenkenRirekiByTenkenrireki",{"id":rirekiId},function(data){
            if(data=="login"){
                logoutFun();
            }
    ...
    function saveKenan(){
        ...
        $.post("/sakade/kenan/saveKenanWithForm",{"kenanForm":kenanFormJson},function(data){
            if(data=="login"){
                logoutFun();
            }
    ...
    function checkKouji(){
        ...
        //DBにてチェックする
        $.ajax({
            url:"/sakade/kouji/getResultForKoujiVNoCheckEdit",
            type: "POST",
        ...
        if(updateFlg==1){
            ...
            $.post("/sakade/kouji/instruct/updateKoujiJson",{"koujiForm":koujiFormJson},function(data){
                if(data=="login"){
                    logoutFun();
                }
