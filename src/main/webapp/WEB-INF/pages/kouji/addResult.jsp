            ...
            <div class="col-md-12">
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                        <form id="KoujiForm" name="KoujiForm" action="/sakade/kouji/add" method="post">
                ...
                <div class="panel">
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-2"><a href="/sakade/kouji/${kouji.id}/saveResult" class="btn btn-success btn-block"><i class="fa fa-save"> 完成</i></a></div>
                            <div class="col-md-4"></div>
                        </div>
                    </div>
                </div>
