                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul class="nav nav-pills nav-stacked bookmarkUl">
                            ...
                            <li role="presentation" class="currentBookmark"><a href="/sakade/kouji/${kouji.id}/history"><i class="glyphicon glyphicon-time"> 履歴</i></a></li>
...
<script type="text/javascript">
    ...
    function changePage(){
        ...
        $.get("/sakade/tenken/getTenkenrirekiHitoryByPage",{"currentPage":currentPage},function(data){
