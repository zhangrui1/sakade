                ...
                <div class="col-md-11">
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <form name="printReportDL" action="/sakade/print/printReport/${kouji.id}" method="post" onsubmit="checkIdListNullForPrintReport();return false;">
                                ...
                                <div class="col-md-4">
                                    <form name="PrintKenanReport" action="/sakade/print/printKenanReport/${kouji.id}" method="post" onsubmit="checkIdListNullForPrintKenanReport();return false;">
                        ...
                        <div class="panel panel-warning">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <form name="printKenan" action="/sakade/print/printKenan/${kouji.id}" method="post" onsubmit="checkIdListNullForPrintKenan();return false;">
                                        ...
                                        <div class="col-md-4">
                                            <form name="printSagyo" action="/sakade/print/printSagyo/${kouji.id}" method="post" onsubmit="checkIdListNullForPrintSagyo();return false;">
                                        ...
                                        <div class="col-md-4">
                                            <form name="ValveRabelDL" action="/sakade/print/printValve/${kouji.id}" method="post" onsubmit="setvalveRadio();return false;">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <form  name="printTenken" action="/sakade/print/printTenken/${kouji.id}" method="post" onsubmit="checkIdListNullForPrintTenken();return false;">
                                        ...
                                        <div class="col-md-4">
                                            <form name="printIcs"  action="/sakade/print/printIcs/${kouji.id}" method="post" onsubmit="checkIdListNullForPrintIcs();return false;">
                                        ...
                                        <div class="col-md-4">
                                            <form name="printTool" action="/sakade/print/printTool/${kouji.id}" method="post" onsubmit="checkIdListNullForPrintTool();return false;">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="nav nav-pills nav-stacked bookmarkUl">
                                ...
                                <li role="presentation" class="currentBookmark"><a href="/sakade/kouji/${kouji.id}/printhtml"><i class="glyphicon glyphicon-download"> DL</i></a></li>
