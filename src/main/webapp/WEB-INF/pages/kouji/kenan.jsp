                    ...
                    <div class="col-md-8">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="/sakade/kouji/${kouji.id}/kenan">今回懸案リスト</a></li>
                                <li><a href="/sakade/kouji/${kouji.id}/kenanPast">過去懸案リスト</a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul class="nav nav-pills nav-stacked bookmarkUl">
                            ...
                            <li role="presentation" class="currentBookmark"><a href="/sakade/kouji/${kouji.id}/kenan"><i class="glyphicon glyphicon-floppy-save"> 懸案</i></a></li>
...
//        $("#kenanForm").submit();
        ...
        $.post("/sakade/kenan/updateKenan",{"kenanForm":kenanFormJson},function(data) {
            if(data=="login"){
                logoutFun();
            }
            $.post("/sakade/kouji/kenanNowYear",{"koujiId":datas[1].value,"kikiSysId":datas[4].value},function(data){
                        if(data=="login"){
                            logoutFun();
                        }
...
//                            '<td class="data-td">'+kikiDatas[i].syotiNaiyou+'</td>'+
    ...
    function deleteKenan(obj){
        ...
        $.post("/sakade/kenan/deleteKenanByKenanId",{"kenanId":kenanId},function(data) {
            if(data=="login"){
                logoutFun();
            }
    ...
    function chooseThisValveNowKenan(obj){
        ...
        $.post("/sakade/kouji/kenanNowYear",{"koujiId":koujiId,"kikiSysId":kikiSysId},function(data){
                if(data=="login"){
                    logoutFun();
                }
                var kikiDatas = JSON.parse(data);
...
//                            '<td class="data-td">'+kikiDatas[i].syotiNaiyou+'</td>'+
    ...
    function editKenanTest(obj){
        var kenanTr = $(obj).parent().parent();
        var kenanId = kenanTr[0].id;
        $.post("/sakade/kenan/getKenanByKenanId",{"kenanId":kenanId},function(data){
            if(data=="login"){
                logoutFun();
            }
