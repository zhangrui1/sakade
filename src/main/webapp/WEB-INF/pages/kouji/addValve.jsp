            ...
            <div class="col-md-8">
                <div class="panel panel-default">
                    ...
                    <div class="panel-footer">
                        <%--<form action="/sakade/kouji/${kouji.id}/valve" id="valveListForm" method="post">--%>
                            <%--<input type="hidden" name="idList" id="idList" value="" />--%>
                            <%--<button class="btn btn-success btn-sm" onclick="submitForm()">追加</button>--%>
                        <%--</form>--%>
                        <%--<form action="/sakade/kouji/${kouji.id}/kiki" id="valveList" method="post">--%>
...
//        return false;
    ...
    function searchByVNO(){
        ...
        var vNo = $('#vNo').val();
        $.post('/sakade/item/getKikiSysIdByVNoJson',
                ({"vNo":vNo,
                  "koujiId":koujiId}),
        function(data){
