                ...
                <div class="panel">
                    <div class="panel-body">
                        <%--<div class="row filter-panel">--%>
                            ...
                            <%--<div class="col-md-6"><a href="/sakade/kouji/${kouji.id}/saveValveKikiRelation" class="btn btn-success btn-sm pull-right">確定</a></div>--%>
                        <%--</div>--%>
                ...
                <div class="panel">
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-2"><a href="/sakade/kouji/${kouji.id}/valve" class="btn btn-default btn-block"><i class="fa fa-backward"> 戻す</i></a></div>
                            <div class="col-md-2"><a href="/sakade/kouji/${kouji.id}/saveValveKikiRelation" class="btn btn-success btn-block" onclick="return checkValveAndTenenKiki();"><i class="fa fa-save"> 確定</i></a></div>
                            <div class="col-md-4"></div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        $.get("/sakade/kouji/valveStatus",function(data){
            if(data=="login"){
                logoutFun();
            }
...
//        return false;
    ...
    function chooseThisValve(obj){
        ...
        $.post("/sakade/item/getKikiByKikiSysId",{"koujiId":koujiId,"kikiSysId":id.value,"syukan":syukanValve.value},
                function(data){
                    if(data=="login"){
                        logoutFun();
                    }
    ...
    function selectKiki(obj){
        ...
        if($(obj).hasClass("active")) {
            $.post("/sakade/item/saveStatusToSession", {"koujiId":koujiId,"kikiSysId": $('#currentKikiSysId').val(), "kikiId": obj.id, "status": "active"},function(data){
                if(data=="login"){
                    logoutFun();
                }
            ...
            $.post("/sakade/item/saveStatusToSession", {"koujiId":koujiId,"kikiSysId": $('#currentKikiSysId').val(), "kikiId": obj.id, "status": ""},function(data){
                if(data=="login"){
                    logoutFun();
                }
