                ...
                <div class="col-md-11">
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-1">
                                    <form name="gp" action="/sakade/print/printGP/${kouji.id}/" id="valveListFormGP" method="post" onsubmit="checkGP();return false;">
                                ...
                                <div class="col-md-1">
                                    <form name="ics" action="/sakade/print/printICS/${kouji.id}/" id="valveListFormICS" method="post" onsubmit="checkICS();return false;">
                                ...
                                <div class="col-md-1">
                                    <form  name="KanriDaiTyoListDL" action="/sakade/print/printKanriDaiTyoForKikisysList/"  method="post" onsubmit="checkKanriDaiTyoListNull();return false;">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="nav nav-pills nav-stacked bookmarkUl">
                                ...
                                <li role="presentation" class="currentBookmark"><a href="/sakade/kouji/${kouji.id}/gpPrinthtml"><i class="glyphicon glyphicon-download"> GP&ICS</i></a></li>
                            </ul>
                        </div>
                    </div>
                </div><!-- tab button tab -->
...
//    ICS画像があるかどうかチェック
    function checkICS(){
        ...
        $.post("/sakade/print/checkPrintICS",{"idList":idList}, function(data){
            if(data=="login"){
                logoutFun();
            }
    ...
    function checkGP(){
        ...
        $.post("/sakade/print/checkPrintGP",{"idList":idList}, function(data){
            if(data=="login"){
                logoutFun();
            }
