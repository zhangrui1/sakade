...
<script type="text/javascript">
    ...
    function updateKenan(){
        ...
        $.post("/sakade/kenan/updateKenan",{"kenanForm":kenanFormJson},function(data) {
            ...
            $.post("/sakade/kouji/kenanLastYear",{"koujiId":${kouji.id},"kikiSysId":datas[4].value},function(data1){
                    if(data=="login"){
                        logoutFun();
                    }
...
//                            '<td class="data-td">'+kikiDatas[i].syotiNaiyou+'</td>'+
    ...
    function chooseThisValveLastKenan(obj){
        ...
        $.post("/sakade/kouji/kenanLastYear",{"koujiId":koujiId,"kikiSysId":kikiSysId},function(data){
                    if(data=="login"){
                        logoutFun();
                    }
