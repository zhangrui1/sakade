            ...
            <div class="row">
                <div class="col-md-11">
                    <div class="panel panel-default">
                        ...
                        <form action="/sakade/kouji/updateKouji">
                        ...
                        <div class="panel panel-default progress-panel" id="tenkenRireki-content">
                            ...
                            <div class="tab-content box-body">
                                <table class="table table-hover kiki-table table-bordered" id="kiki-table">
                                    ...
                                    <tbody>
                                    <c:forEach items="${valveList}" var="tempValve">

                                        <tr id="${tempValve.kikiSysId}">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="nav nav-pills nav-stacked bookmarkUl">
                                <li role="presentation" class="currentBookmark"><a href="/sakade/kouji/${kouji.id}"><i class="glyphicon glyphicon-cog"> 情報</i></a></li>
