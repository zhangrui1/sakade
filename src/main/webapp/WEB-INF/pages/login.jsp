...
<div class="form-box" id="login-box">
    <%--<c:if test="${message != null}">--%>
        ...
        <%--</div>--%>
    <%--</c:if>--%>
    <div class="header bg-black-gradient">Valdac  G</div>
    <form id="userForm" name="userForm"  action="/sakade/login" onclick="return check()" method="post">
...
<!-- Bootstrap -->
<script src="/sakade/js/bootstrap.min.js" type="text/javascript"></script>
