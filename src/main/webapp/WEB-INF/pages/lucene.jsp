            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-4">
                                <form action="/sakade/lucene/luceneValve">
                                    <input type="submit" class="btn btn-default" value="弁作成"/>
                                </form>
                            </div>
                            <div class="col-md-4">
                                <form action="/sakade/lucene/luceneKiki">
                                    <input type="submit" class="btn btn-default" value="機器作成"/>
                                </form>
                            </div>
                            <div class="col-md-4">
                                <form action="/sakade/lucene/luceneBuhin">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-4">
                                <form action="/sakade/lucene/luceneKouji">
                                    <input type="submit" class="btn btn-default" value="工事作成"/>
                                </form>
                            </div>
                            <div class="col-md-4">
                                <form action="/sakade/lucene/luceneKoujirelation">
                                    <input type="submit" class="btn btn-default" value="工事関係表作成"/>
                                </form>
                            </div>
                            <div class="col-md-4">
                                <form action="/sakade/lucene/luceneTenkenRireki">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-4">
                                <form action="/sakade/lucene/luceneKoujiIDTenkenRireki">
                                    <input type="submit" class="btn btn-default" value="工事ID点検履歴作成"/>
                                </form>
                            </div>
                            <div class="col-md-4">
                                <form action="/sakade/lucene/luceneKenan">
